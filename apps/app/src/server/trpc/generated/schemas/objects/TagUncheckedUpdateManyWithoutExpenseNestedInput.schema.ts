...
const Schema: z.ZodType<Prisma.TagUncheckedUpdateManyWithoutExpenseNestedInput> = z.union([
  z.object({
    create: z
      .union([
...
export const TagUncheckedUpdateManyWithoutExpenseNestedInputObjectSchema = Schema;
