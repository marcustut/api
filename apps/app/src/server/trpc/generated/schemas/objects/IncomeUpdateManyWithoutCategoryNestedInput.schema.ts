...
const Schema: z.ZodType<Prisma.IncomeUpdateManyWithoutCategoryNestedInput> = z.union([
  z.object({
    create: z
      .union([
...
export const IncomeUpdateManyWithoutCategoryNestedInputObjectSchema = Schema;
