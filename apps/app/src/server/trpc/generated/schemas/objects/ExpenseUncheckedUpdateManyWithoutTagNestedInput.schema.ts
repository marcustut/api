...
const Schema: z.ZodType<Prisma.ExpenseUncheckedUpdateManyWithoutTagNestedInput> = z.union([
  z.object({
    create: z
      .union([
...
export const ExpenseUncheckedUpdateManyWithoutTagNestedInputObjectSchema = Schema;
