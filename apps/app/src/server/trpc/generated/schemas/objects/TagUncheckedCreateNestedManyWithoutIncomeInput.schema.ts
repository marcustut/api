...
const Schema: z.ZodType<Prisma.TagUncheckedCreateNestedManyWithoutIncomeInput> = z.union([
  z.object({
    create: z
      .union([
...
export const TagUncheckedCreateNestedManyWithoutIncomeInputObjectSchema = Schema;
