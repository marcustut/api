...
const Schema: z.ZodType<Prisma.IncomeWhereInput> = z
  .object({
    AND: z
      .union([
        z.lazy(() => IncomeWhereInputObjectSchema),
        z.lazy(() => IncomeWhereInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
      .lazy(() => IncomeWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
...
export const IncomeWhereInputObjectSchema = Schema;
