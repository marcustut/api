...
const Schema: z.ZodType<Prisma.ExpenseUncheckedUpdateManyWithoutCategoryNestedInput> = z.union([
  z.object({
    create: z
      .union([
...
export const ExpenseUncheckedUpdateManyWithoutCategoryNestedInputObjectSchema = Schema;
