...
const Schema: z.ZodType<Prisma.IncomeUncheckedCreateNestedManyWithoutCategoryInput> = z.union([
  z.object({
    create: z
      .union([
...
export const IncomeUncheckedCreateNestedManyWithoutCategoryInputObjectSchema = Schema;
