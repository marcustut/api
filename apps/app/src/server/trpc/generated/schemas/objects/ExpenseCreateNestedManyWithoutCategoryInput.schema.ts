...
const Schema: z.ZodType<Prisma.ExpenseCreateNestedManyWithoutCategoryInput> = z.union([
  z.object({
    create: z
      .union([
...
export const ExpenseCreateNestedManyWithoutCategoryInputObjectSchema = Schema;
