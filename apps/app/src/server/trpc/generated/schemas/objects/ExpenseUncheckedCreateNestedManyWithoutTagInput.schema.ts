...
const Schema: z.ZodType<Prisma.ExpenseUncheckedCreateNestedManyWithoutTagInput> = z.union([
  z.object({
    create: z
      .union([
...
export const ExpenseUncheckedCreateNestedManyWithoutTagInputObjectSchema = Schema;
