...
const Schema: z.ZodType<Prisma.ExpenseUpdateManyWithWhereWithoutCategoryInput> = z
  .object({
...
export const ExpenseUpdateManyWithWhereWithoutCategoryInputObjectSchema = Schema;
